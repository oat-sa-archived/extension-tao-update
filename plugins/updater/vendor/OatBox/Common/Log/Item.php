...
class Item
{
    ...
    public function getSeverityDescriptionString()
    {
        ...
        switch ($this->severity) {
        	case Common\Logger::TRACE_LEVEL:
        		$returnValue = "TRACE";break;
        	case Common\Logger::DEBUG_LEVEL:
        		$returnValue = "DEBUG";break;
        	case Common\Logger::INFO_LEVEL:
        		$returnValue = "INFO";break;
        	case Common\Logger::WARNING_LEVEL:
        		$returnValue = "WARNING";break;
        	case Common\Logger::ERROR_LEVEL:
        		$returnValue = "ERROR";break;
        	case Common\Logger::FATAL_LEVEL:
