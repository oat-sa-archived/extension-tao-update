...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= $this->assets('css/maintenance.css');?>" />
</head>
...
<body>
	<div id="main">
		<div id="content">
			...
			<p id="warning_msg">
				<img src="<?= $this->assets('img/warning_error_tpl.png');?>" alt="warning" class="embedWarning" />Update in progress...</p>
